...
const DEFAULT_SUBSCRIPTIONS = [
  ...
  {
    code: "event-search-product-released",
    name: "Search: product released",
    description: "Reindex the released product so it is searchable.",
    event_type_code: "ProductReleased",
    handler: "search.index",
    queue_code: "event-consumers",
    consumer_group: "event-default",
  ...
  {
    code: "event-workflow-product-released",
    name: "Workflow: product released",
    description: "Evaluate workflow bindings when a product is released.",
    event_type_code: "ProductReleased",
    handler: "workflow.trigger",
    queue_code: "event-consumers",
    consumer_group: "event-default",
  ...
  {
    code: "event-analytics-product-released",
    name: "Analytics: product released",
    description: "Record product releases as analytics facts.",
    event_type_code: "ProductReleased",
    handler: "analytics.record",
    queue_code: "event-consumers",
    consumer_group: "event-default",
  ...
  {
    code: "event-notify-product-released",
    name: "Notifications: product released",
    description: "Dispatch notifications when a product is released.",
    event_type_code: "ProductReleased",
