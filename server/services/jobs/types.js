...
const DEFAULT_TYPES = [
  ...
  {
    code: "CONTENT_SECURITY_SCAN",
    name: "Content security scan",
    description: "Run the pluggable malware scan pipeline for a content version.",
    source_module: "content",
    handler: "content.scan",
    queues: ["default"],
    timeout_seconds: 900,
    max_retries: 2,
    default_priority: "high",
  ...
  {
    code: "CONTENT_RENDITION",
    name: "Content rendition generation",
    description: "Generate a PDF, JT, preview, thumbnail or text rendition for content.",
    source_module: "content",
    handler: "content.rendition",
    queues: ["default"],
    timeout_seconds: 1800,
    max_retries: 2,
    default_priority: "normal",
  ...
  {
    code: "CONTENT_RETENTION",
    name: "Content retention evaluation",
    description: "Evaluate content retention policies and mark expired records eligible.",
    source_module: "content",
    handler: "content.retention",
    queues: ["default"],
    timeout_seconds: 1800,
    max_retries: 1,
    default_priority: "low",
  ...
  {
    code: "CONTENT_MAINTENANCE",
    name: "Content estate maintenance",
    description: "Expire upload staging, release stale locks, evaluate retention and reindex content.",
    source_module: "content",
    handler: "CONTENT_MAINTENANCE",
    queues: ["default"],
    timeout_seconds: 1800,
    max_retries: 1,
    default_priority: "low",
  },
  {
    ...
    description: "Drain queued search index changes for a tenant or object type.",
    source_module: "search",
  ...
  },
  {
    ...
    description: "Rebuild the search index for a tenant or a registered object type.",
    source_module: "search",
  ...
  {
    code: "SEARCH_EXPORT",
    name: "Search result export",
    description: "Materialise a search result set as a CSV or JSON export.",
    source_module: "search",
    handler: "search.export",
    queues: ["default"],
    timeout_seconds: 1800,
    max_retries: 2,
    default_priority: "normal",
  ...
  {
    code: "INTEGRATION_MESSAGE",
    name: "Integration message delivery",
    description: "Deliver queued integration messages with retry and dead-letter handling.",
    source_module: "integration",
    handler: "integration.message",
    queues: ["INTEGRATION", "default"],
    timeout_seconds: 900,
    max_retries: 3,
    default_priority: "normal",
  },
  {
    code: "INTEGRATION_EVENT_DISPATCH",
    name: "Integration event dispatch",
    description: "Fan out published domain events to internal and webhook subscribers.",
    source_module: "integration",
    handler: "integration.eventDispatch",
    queues: ["INTEGRATION", "default"],
    timeout_seconds: 900,
    max_retries: 3,
    default_priority: "high",
  ...
  {
    code: "INTEGRATION_TRANSFER",
    name: "Integration import/export",
    description: "Execute a bulk import or export data transfer.",
    source_module: "integration",
    handler: "integration.transfer",
    queues: ["INTEGRATION", "default"],
    timeout_seconds: 3600,
    max_retries: 1,
    default_priority: "normal",
  ...
  {
    code: "INTEGRATION_HEALTH_CHECK",
    name: "Integration health check",
    description: "Probe configured external systems and record health history.",
    source_module: "integration",
    handler: "integration.healthCheck",
    queues: ["INTEGRATION", "default"],
    timeout_seconds: 900,
    max_retries: 1,
    default_priority: "low",
  ...
  {
    code: "INTEGRATION_DEAD_LETTER_RETRY",
    name: "Integration dead-letter retry",
    description: "Reprocess integration dead letters selected by an operator.",
    source_module: "integration",
    handler: "integration.deadLetterRetry",
    queues: ["INTEGRATION", "default"],
    timeout_seconds: 1800,
    max_retries: 0,
    default_priority: "normal",
  ...
  {
    code: "EVENT_OUTBOX_PUBLISH",
    name: "Event outbox publish",
    description: "Publish pending transactional-outbox events and fan them out to subscriptions.",
    source_module: "events",
    handler: "events.outboxPublish",
    queues: ["EVENTS", "default"],
    timeout_seconds: 900,
    max_retries: 3,
    default_priority: "high",
  },
  {
    code: "EVENT_CONSUME",
    name: "Event consume",
    description: "Claim and process due event deliveries with retry, ordering and dead-letter handling.",
    source_module: "events",
  ...
  },
  {
    code: "EVENT_REPLAY",
    name: "Event replay",
    description: "Execute a validated, controlled replay of historical events.",
    source_module: "events",
    handler: "events.replay",
    queues: ["EVENTS", "default"],
  ...
  {
    code: "EVENT_RETENTION",
    name: "Event retention",
    description: "Apply event retention policies: archive and/or delete expired events.",
    source_module: "events",
    handler: "events.retention",
    queues: ["default"],
    timeout_seconds: 3600,
    max_retries: 1,
    default_priority: "low",
  },
  {
    ...
    name: "Event framework maintenance",
    description: "Reclaim stale outbox/delivery leases, prune published outbox rows and purge resolved dead letters.",
    source_module: "events",
    handler: "events.maintenance",
    queues: ["default"],
    timeout_seconds: 1800,
    max_retries: 1,
    default_priority: "low",
  ...
  {
    code: "DATA_QUALITY_BATCH",
    name: "Data quality batch evaluation",
    description: "Evaluate every governed object of one or more object types and persist results.",
    source_module: "data-governance",
    handler: "dataQuality.batch",
    queues: ["default"],
    timeout_seconds: 3600,
    max_retries: 1,
    default_priority: "normal",
  ...
  {
    code: "DATA_QUALITY_SCHEDULED",
    name: "Data quality scheduled evaluation",
    description: "Evaluate data quality on the schedule configured by a data steward.",
    source_module: "data-governance",
    handler: "dataQuality.scheduled",
    queues: ["default"],
    timeout_seconds: 3600,
    max_retries: 1,
    default_priority: "normal",
  ...
  {
    code: "DATA_QUALITY_DUPLICATES",
    name: "Data quality duplicate detection",
    description: "Run configured duplicate match rules and record candidate findings.",
    source_module: "data-governance",
    handler: "dataQuality.duplicates",
    queues: ["default"],
    timeout_seconds: 1800,
    max_retries: 1,
    default_priority: "normal",
  ...
  {
    code: "DATA_QUALITY_MAINTENANCE",
    name: "Data quality maintenance",
    description: "Escalate overdue exceptions and prune expired quality history.",
    source_module: "data-governance",
    handler: "dataQuality.maintenance",
    queues: ["default"],
    timeout_seconds: 1800,
    max_retries: 1,
    default_priority: "low",
