// Tenant- and version-aware PDM read cache.
//
// Revision trees, rule resolution and where-used adjacency are read on every
// navigation and algorithm pass, so hot reads are cached. The cache is keyed by
// tenant and invalidated by a per-tenant epoch that every structural write bumps.
// It never caches authorization decisions.
const store = new Map();
